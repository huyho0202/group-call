...
import org.jitsi.meet.sdk.InviteFriendModule;
 ...
 */
public class MainActivity extends JitsiMeetActivity implements InviteFriendModule.InviteEventHandler {
    /**
    ...
    protected void initialize() {
        ...
        new Handler().postDelayed(() -> JitsiMeetActivity.initListener(MainActivity.this), 2000);
        super.initialize();
    }

    @Override
    public void invitedFriendTest(Double invitedUin) {
        Log.e(TAG, "invitedFriendTest invitedUin: " + invitedUin);
    }
    ...
    private void setJitsiMeetConferenceDefaultOptions() {
        ...
        userInfo.putString("tokenNetalo", "74cab9f3a125b91539b7d99ef37b8190c9a8c168");
        userInfo.putString("cdnEndpoint", "https://dev.ss1.netalo.vn/profiles/");
        userInfo.putString("apiEndpoint", "https://dev.api.netalo.vn/");
        JitsiMeetUserInfo userInfoMain = new JitsiMeetUserInfo(userInfo);
