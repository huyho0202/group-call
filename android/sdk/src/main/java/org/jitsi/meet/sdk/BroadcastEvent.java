...
public class BroadcastEvent {
    ...
    public enum Type {
        ...
        INVITE_FRIEND_CHANGED("org.jitsi.meet.INVITE_FRIEND_CHANGED");
        ...
        private static final String INVITE_FRIEND_CHANGED_NAME = "INVITE_FRIEND_CHANGED";
        ...
        private static Type buildTypeFromName(String name) {
            switch (name) {
                ...
                case INVITE_FRIEND_CHANGED_NAME:
                    return INVITE_FRIEND_CHANGED;
            }
