...
public class JitsiMeetUserInfo {
    ...
    public JitsiMeetUserInfo(Bundle b) {
        ...
        if (b.containsKey("tokenNetalo")) {
            tokenNetalo = b.getString("tokenNetalo");
        }

        if (b.containsKey("cdnEndpoint")) {
            cdnEndpoint = b.getString("cdnEndpoint");
        }

        if (b.containsKey("apiEndpoint")) {
            apiEndpoint = b.getString("apiEndpoint");
        }
    ...
    Bundle asBundle() {
        ...
        if (tokenNetalo != null) {
            b.putString("tokenNetalo", tokenNetalo);
        }

        if (cdnEndpoint != null) {
            b.putString("cdnEndpoint", cdnEndpoint);
        }

        if (apiEndpoint != null) {
            b.putString("apiEndpoint", apiEndpoint);
        }
