...
public class JitsiMeetActivity extends FragmentActivity
    ...
    public static void initListener(InviteFriendModule.InviteEventHandler inviteEventHandler) {
        JitsiMeetLogger.e("invitedUin 0000");
        InviteFriendModule module = ReactInstanceManagerHolder.getNativeModule(InviteFriendModule.class);
        if (module != null) {
            JitsiMeetLogger.e("invitedUin 1111");
            module.initInviteFriendModule(inviteEventHandler);
        }
    }
