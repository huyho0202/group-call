...
/**
 * The type of the React {@code Component} props of {@link InviteList}.
 */
type Props = {
 ...
 */
let InviteList_; // eslint-disable-line prefer-const

/**
 * Implements a React {@code Component} with some extra actions in addition to
 * those in the toolbar.
 */
class InviteList extends PureComponent<Props, State> {
    /**
     * Initializes a new {@code InviteList} instance.
     *
     * @inheritdoc
     */
    constructor(props: Props) {
        ...
        this._onCloseInviteList = this._onCloseInviteList.bind(this);
    }
    ...
    render() {
        ...
        const { showMore, showListFriend } = this.state;
        ...
        return (
            <BottomSheet
                ...
                <FriendList onCancel = { this._onCloseInviteList }/>
    ...
    handleInvite() {
        // let showListFriend = this.state.showListFriend
        this.setState({showListFriend: true}, () => {
    ...
    _onCancel() {
        if (this.props._isOpen) {
            this.props.dispatch(hideDialog(InviteList_));
            return true;
        }
    ...
    _onCloseInviteList() {
        try {
            this.setState({showListFriend: false}, () => {
                this.props.dispatch(hideDialog(InviteList_));
            })
        } catch(e) {
        }
...
function _mapStateToProps(state) {
    return {
        ...
        _isOpen: isDialogOpen(state, InviteList_),
        _width: state['features/base/responsive-ui'].clientWidth
    };
}

InviteList_ = connect(_mapStateToProps)(InviteList);

export default InviteList_;
