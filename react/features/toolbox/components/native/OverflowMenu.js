    ...
    render() {
        ...
        return (
            <BottomSheet
                ...
                {(!toolbarButtons.has('invite') && !showListFriend) && <NewInviteButton { ...newButtonProps } handleInvite={this.handleInvite}/>}
                {/*!showListFriend && <ScreenSharingButton { ...buttonProps } />*/}

                {(!toolbarButtons.has('tileview') && !showListFriend) && <TileViewButton { ...buttonProps } />}
                {!showListFriend && <MuteEveryoneButton { ...buttonProps } />}
                {!showListFriend && <MuteEveryonesVideoButton { ...buttonProps } />}
                    
                {showListFriend && <FriendList onCancel = { this._onCloseInviteList }/>}
