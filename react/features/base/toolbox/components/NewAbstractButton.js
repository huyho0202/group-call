...
// import FriendList from '../../../toolbox/components/native/FriendList';
...
export default class AbstractButton<P: Props, S: *> extends Component<P, S> {
    ...
    _onClick() {
        ...
        alert('22222')
        this.setState({flagInviteList: true})
    }
    ...
    render(): React$Node {
        ...
        return (
            <View>
                {!this.state.flagInviteList && <ToolboxItem
                    disabled = { this._isDisabled() }
                    onClick = { this._onClick }
                    { ...props } />
                }
                {this.state.flagInviteList && <FriendList onCancel = { this._onCloseInviteList }/>}
            </View>
