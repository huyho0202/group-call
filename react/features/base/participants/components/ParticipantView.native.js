...
import { getParticipantCount, getParticipantDisplayName } from '../../../base/participants';
...
import ConferenceTimerNew from './ConferenceTimerNew';
    ...
    render() {
        ...
        return (
            <Container
                ...
                {/* _isLonelyMeeting && <View style = { styles.avatarContainer }>
                    <Avatar
                        participantId = { this.props.participantId }
                        size = { this.props.avatarSize } />
