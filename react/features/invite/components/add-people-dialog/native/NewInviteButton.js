...
import { IconNewAddPeople } from '../../../../base/icons';
 ...
 */
class NewInviteButton extends AbstractButton<Props, *> {
    accessibilityLabel = 'toolbar.accessibilityLabel.shareRoom';
    icon = IconNewAddPeople;
...
export default translate(connect(_mapStateToProps)(NewInviteButton));
